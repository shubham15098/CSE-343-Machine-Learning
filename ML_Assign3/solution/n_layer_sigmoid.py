...
for i in xrange(10000):
  ...
  hidden_layer.append(float(1) / (1.0 + np.exp(-(np.dot(X, w_array[0]) + b_array[0]))))
  for k2 in range(len(h)-1):
    hidden_layer.append(float(1) / (1.0 + np.exp(-(np.dot(hidden_layer[k2], w_array[k2+1]) + b_array[k2+1]))))
  ...
  dhidden_array[0] = np.multiply(dhidden_array[0],np.multiply(hidden_layer[len(hidden_layer)-1],(1-hidden_layer[len(hidden_layer)-1])))
  ...
  for k4 in range(len(hidden_layer)-2):
    ...
    dhidden_array[len(dhidden_array)-1] = np.multiply(dhidden_array[len(dhidden_array)-1],np.multiply(hidden_layer[len(hidden_layer)-1-(k4+1)],(1-hidden_layer[len(hidden_layer)-1-(k4+1)])))
  ...
  dhidden_array[len(dhidden_array)-1] = np.multiply(dhidden_array[len(dhidden_array)-1],np.multiply(hidden_layer[0],(1-hidden_layer[0])))
